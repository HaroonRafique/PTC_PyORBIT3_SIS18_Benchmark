...
from common.legacy_plot_comparison import comparison_grid_shape, plot_legacy_comparison, plot_same_axes_references
...
def test_same_axes_reference_grid_is_compact_for_five_panels():
    assert comparison_grid_shape(5) == (2, 3)
