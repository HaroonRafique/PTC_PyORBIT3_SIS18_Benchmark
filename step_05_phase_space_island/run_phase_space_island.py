...
def main(argv: list[str] | None = None) -> int:
    ...
    args = parser.parse_args(argv); config = load_step_config(ROOT / "shared_inputs" / "benchmark_profiles.json", step=5, profile=args.profile); particles, turns = args.particles or config.n_macroparticles, args.turns or config.turns
